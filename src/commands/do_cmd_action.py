...
def do_cmd_action(struct player_live_record *player, struct command *info):
...
def do_system_cmd(struct player_live_record *player, struct command *info):
...
def do_info_cmd(struct player_live_record *player, struct command *info):
...
def do_room_cmd(struct player_live_record *player, struct command *info):
...
def do_movement_cmd(struct player_live_record *player, struct command *info):
	int32_t dir = 0;
	int32_t rv = 0;
